#This file conducts the data cleaning.
rm(list=ls())
require(car)
require("MVA")
require("biwt")

#detect and redeem wrong records
...
#detect anomalies for the response, keep all
...
#detect anomalies for the response, delete 39,41
...
#high influential points, 31 is one but we keep it
options(repr.plot.width=6, repr.plot.height=6)
bodyfat$IDNO=NULL
...
#save clean data
write.csv(bodyfat[-c(39,41,48,76,96,182),],"../data/cleanfile.csv")
